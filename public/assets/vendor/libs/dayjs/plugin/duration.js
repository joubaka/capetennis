...
/***/ "./resources/assets/vendor/libs/dayjs/plugin/duration.js":
/*!***************************************************************!*\
  !*** ./resources/assets/vendor/libs/dayjs/plugin/duration.js ***!
  \***************************************************************/
  ...
  var t,
    ...
    g = function () {
      ...
      return y.calMilliseconds = function () {
        ...
        var s = this.$ms,
          n = m(t);
        return "milliseconds" === n ? s %= 1e3 : s = "weeks" === n ? $(s / h[n]) : this.$d[n], 0 === s ? 0 : s;
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/assets/vendor/libs/dayjs/plugin/duration.js");
/******/ 	
