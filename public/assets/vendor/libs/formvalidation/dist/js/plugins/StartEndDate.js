  ...
  var e = /*#__PURE__*/function (_t) {
    ...
    _createClass(e, [{
      ...
      value: function install() {
        ...
        this.start_dateFieldOptions = t[this.opts.start_date.field];
        this.endDateFieldOptions = t[this.opts.endDate.field];

        var _e = this.core.getFormElement();

        this.core.on("core.field.valid", this.fieldValidHandler).on("core.field.invalid", this.fieldInvalidHandler).addField(this.opts.start_date.field, {
          validators: {
            date: {
              ...
              message: this.opts.start_date.message
            }
          }
          ...
          validators: {
            date: {
              ...
              min: function min() {
                var t = _e.querySelector("[name=\"".concat(_this2.opts.start_date.field, "\"]"));
      ...
      value: function uninstall() {
        this.core.removeField(this.opts.start_date.field);

        if (this.start_dateFieldOptions) {
          this.core.addField(this.opts.start_date.field, this.start_dateFieldOptions);
        }
      ...
      value: function onFieldInvalid(t) {
        switch (t) {
          case this.opts.start_date.field:
            this.start_dateValid = false;
            break;
      ...
      value: function onFieldValid(t) {
        switch (t) {
          ...
          case this.opts.endDate.field:
            ...
            if (this.start_dateValid === false) {
              this.core.revalidateField(this.opts.start_date.field);
            }
