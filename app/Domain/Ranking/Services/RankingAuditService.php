    ...
    public function buildReport(Series $series): array
    {
        ...
        return [
            'series'              => [
                ...
                'use_third_score_tiebreak' => $series->use_third_score_tiebreak,
                'use_last_leg_position_tiebreak' => $series->use_last_leg_position_tiebreak,
                'use_head_to_head_tiebreak' => $series->use_head_to_head_tiebreak,
            ],
