...
Route::prefix('backend')->middleware('auth')->group(function () {
  ...
  Route::middleware('role:super-user|admin')->prefix('masters')->name('backend.masters.')->group(function () {
    ...
    Route::post('invitations/{invitation}/mark-paid', [\App\Http\Controllers\Backend\MastersInvitationController::class, 'markPaid'])->name('invitation.mark-paid');
  ...
  Route::prefix('team-selection')->name('backend.team-selection.')->group(function () {
    ...
    Route::patch('events/{event}/regions/{eventRegion}/teams/{team}/publication', [\App\Http\Controllers\Backend\TeamSelectionInvitationController::class, 'updateTeamPublication'])->name('teams.publication.update');
    ...
    Route::post('events/{event}/imports/{selectionImport}/invitations/{invitation}/restore', [\App\Http\Controllers\Backend\TeamSelectionInvitationController::class, 'restoreDeclined'])->name('invitations.restore');
    Route::post('events/{event}/imports/{selectionImport}/invitations/{invitation}/email/send-restored', [\App\Http\Controllers\Backend\TeamSelectionInvitationController::class, 'sendRestoredInvitation'])->name('invitations.email.send-restored');
    Route::post('events/{event}/imports/{selectionImport}/invitations/{invitation}/mark-paid-privately', [\App\Http\Controllers\Backend\TeamSelectionInvitationController::class, 'markPaidPrivately'])->name('invitations.mark-paid-privately');
    ...
    Route::post('events/{event}/imports/{selectionImport}/invitations/email/send-pending-activated', [\App\Http\Controllers\Backend\TeamSelectionInvitationController::class, 'sendPendingActivatedInvitations'])->name('invitations.email.send-pending-activated');
    Route::post('events/{event}/imports/{selectionImport}/invitations/email/custom-preview', [\App\Http\Controllers\Backend\TeamSelectionInvitationController::class, 'previewCustomPendingActivatedInvitations'])->name('invitations.email.custom-preview');
    Route::post('events/{event}/imports/{selectionImport}/invitations/email/custom-send', [\App\Http\Controllers\Backend\TeamSelectionInvitationController::class, 'sendCustomPendingActivatedInvitations'])->name('invitations.email.custom-send');
...
// Individual schedule
  ...
  Route::post('events/{event}/venue-schedule/manual-options', [EventVenueScheduleController::class, 'manualOptions'])
    ->name('backend.event-venue-schedule.manual-options');
...
// Place it near other backend/team-fixtures routes.
  ...
  Route::post('event/{event}/region/{region}/external-teams/import', [TeamController::class, 'importNoProfileTeams'])
    ->name('backend.region.teams.import.no.profile');
