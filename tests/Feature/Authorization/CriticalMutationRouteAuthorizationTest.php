...
{
    /** @test */
    public function guests_cannot_create_or_modify_events(): void
    {
    ...
    /** @test */
    public function guests_cannot_modify_players_or_ranking_scores(): void
    {
    ...
    /** @test */
    public function guests_cannot_modify_team_fixtures_or_schedules(): void
    {
