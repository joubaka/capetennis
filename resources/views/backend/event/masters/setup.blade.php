...
@section('title', 'Masters invitation setup')
...
@section('content')<div class="container-xl masters-page">@include('backend.event.partials.header',['event'=>$event])<div class="mb-3"><h4 class="mb-1">Masters invitation setup</h4><p class="text-muted mb-0">Choose the Series rankings and create the invitation batch for this Masters event.</p></div>@include('backend.event.masters._setup')</div>@endsection
@section('page-script')
<script>
