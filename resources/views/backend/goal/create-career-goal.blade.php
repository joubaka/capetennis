                    ...
                    <div class="col-sm-3 col-12">
                        ...
                        <div class="switches-stacked mt-4 mb-4">
                            <label class="switch switch-square">
                                <input name="goalDate" type="radio" value="{{$threemonths}}" class="switch-input dates" name="switches-square-stacked-radio">
                                <span class="switch-toggle-slider">
                                    <span class="switch-on"></span>
                                    <span class="switch-off"></span>
                                </span>
                                <span class="switch-label">3 months from today - <span class="badge bg-label-primary">{{$threemonths}}</span></span> </span>
                            </label>

                            <label class="switch switch-square">
                                <input name="goalDate" type="radio" value="{{$sixmonths}}" class="switch-input dates" name="switches-square-stacked-radio">
                                <span class="switch-toggle-slider">
                                    <span class="switch-on"></span>
                                    <span class="switch-off"></span>
                                </span>
                                <span class="switch-label">6 months from today - <span class="badge bg-label-primary"> {{$sixmonths}}</span></span>
                            </label>

                            <label class="switch switch-square">
                                <input name="goalDate" type="radio" value=" {{$oneyear}}" class="switch-input dates" name="switches-square-stacked-radio">
                                <span class="switch-toggle-slider">
                                    <span class="switch-on"></span>
                                    <span class="switch-off"></span>
                                </span>
                                <span class="switch-label">End of the year - <span class="badge bg-label-primary"> {{$oneyear}}</span></span>
                            </label>
                            <label class="switch switch-square">
            ...
            <div id="account-details" class="content">
                ...
                <div class="g-3 mt-2">
                    <div class="col-sm-3 col-12">
                        ...
                        <label for="html5-date-input" class="form-label">Reach {{$type->name}} goal by </label>
                        <div class="switches-stacked mt-4 mb-4">
                            ...
                            <label class="switch switch-square">
                                ...
                                <span class="switch-label">End of next year - <span class="badge bg-label-primary"> {{$nextYear}}</span></span>
                            </label>
                            ...
                            <label class="switch switch-square">
                                ...
                                <span class="switch-label">In 2 years - <span class="badge bg-label-primary"> {{$twoyears}}</span></span>
                            </label>
                            <label class="switch switch-square">
                                <input name="goalDate" id="custom-date" value="customDate" type="radio" class="switch-input" name="switches-square-stacked-radio">
                                <span class="switch-toggle-slider">
            ...
            <div id="account-details" class="content">
                ...
                <div class="g-3 mt-2">
                    <div class="col-sm-3 col-12">
                        ...
                        <div class="switches-stacked mt-4 mb-4">
                            <label class="switch switch-square">
                                <input name="goalDate" type="radio" value="{{$tenyears}}" class="switch-input dates" name="switches-square-stacked-radio">
                                <span class="switch-toggle-slider">
                                    <span class="switch-on"></span>
                                    <span class="switch-off"></span>
                                </span>
                                <span class="switch-label">10 years - <span class="badge bg-label-primary">{{$tenyears}}</span></span> </span>
                            </label>
                            <label class="switch switch-square">
                                <input name="goalDate" type="radio" value="{{$tenyears}}" class="switch-input dates" name="switches-square-stacked-radio">
                                <span class="switch-toggle-slider">
                                ...
                                <span class="switch-label">15 years - <span class="badge bg-label-primary">{{$fifteenyears}}</span></span> </span>
                            </label>
                    ...
                    <div class="col-sm-3 col-12">
                        ...
                        <div class="switches-stacked mt-4 mb-4">
                            <label class="switch switch-square">
                                ...
                                <span class="switch-label">10 years from today - <span class="badge bg-label-primary">{{$tenyears}}</span></span> </span>
                            </label>

                            <label class="switch switch-square">
                                <input name="goalDate" type="radio" value="{{$fifteenyears}}" class="switch-input dates" name="switches-square-stacked-radio">
                                <span class="switch-toggle-slider">
                                    <span class="switch-on"></span>
                                    <span class="switch-off"></span>
                                </span>
                                <span class="switch-label">15 years from today - <span class="badge bg-label-primary"> {{$fifteenyears}}</span></span>
                            </label>
