...
<script src="{{asset('assets/js/draw-team-show-ver-1.js')}}"></script>
...
@include('backend.fixture.fixture-table-admin')
            ...
            <form id="tennisResultForm" >
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"  class="form-control" id="registration-1-name" name="player1" >
                    </div>
                    <!-- Player 2 -->
                    <div class="mb-3">
                        <label for="player2" class="form-label" >Player 2</label>
                        <input type="text"  class="form-control"  id="registration-2-name" name="player2" >
                    </div>
                    <!-- Set 1 -->
                    <div class="row mb-3">
                        <div class="col">
...
<!-- Modal -->
<div class="modal fade result-modal" id="result-modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content  col-12">
            <form action="#" id="submit-result-form">
                ...
                <div class="modal-body">
                    <div class="table-responsive text-nowrap"> @if($draw->settings)
