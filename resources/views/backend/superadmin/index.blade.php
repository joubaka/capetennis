      ...
      <div class="card-header d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center">
          ...
          @if($walletStats['positive_wallets'] > 0)
            <span class="badge bg-label-info ms-2">{{ $walletStats['positive_wallets'] }} with balance</span>
          @endif
        </div>
        <span class="text-muted small">Total Balance: <strong class="text-success">R {{ number_format($walletStats['total_balance'], 2) }}</strong></span>
      </div>
      ...
      <div class="card-body pb-0">
        <div class="row g-3 mb-3">
          <div class="col-6 col-md-3">
            <div class="card border-start border-info border-3 h-100">
              <div class="card-body py-2">
                <small class="text-muted d-block"><i class="ti ti-wallet me-1 text-info"></i>Total Wallets</small>
          ...
          <div class="col-6 col-md-3">
            <div class="card border-start border-success border-3 h-100">
              <div class="card-body py-2">
                <small class="text-muted d-block"><i class="ti ti-coins me-1 text-success"></i>Total Balance</small>
          ...
          <div class="col-6 col-md-3">
            <div class="card border-start border-warning border-3 h-100">
              <div class="card-body py-2">
                <small class="text-muted d-block"><i class="ti ti-trending-up me-1 text-warning"></i>With Balance</small>
          ...
          <div class="col-6 col-md-3">
            <div class="card border-start border-secondary border-3 h-100">
              <div class="card-body py-2">
                <small class="text-muted d-block"><i class="ti ti-circle-minus me-1 text-secondary"></i>Zero Balance</small>
