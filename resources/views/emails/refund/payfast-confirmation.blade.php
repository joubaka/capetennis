...
Your refund for **{{ $eventName }}** has been processed via PayFast.

---

**Event:** {{ $eventName }}
**Category:** {{ $categoryName }}
**Refund method:** PayFast (original payment method)
...
The refund will be returned to your original payment method and may take **3–5 business days** to reflect.
