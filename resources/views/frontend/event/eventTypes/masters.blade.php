...
<div class="masters-public-event col-xl-12"><div class="row mb-4"><div class="col-xl-8 col-lg-7">
  ...
  <div class="card p-4 mb-4"><span class="masters-register-note">Choose your name below to respond to your invitation</span><h4 class="mt-3 mb-1">Masters invitations</h4><p class="text-muted mb-3">Find your name in the correct category. Select <strong>Register</strong> to accept the invitation and continue to PayFast. If you cannot participate, select <strong>Decline invitation</strong> to let us know you will not be playing.</p><div class="masters-category-grid">
  ...
  <div class="card mb-4"><div class="card-body"><small class="text-uppercase">About</small><ul class="list-unstyled mb-4 mt-3"><li class="d-flex align-items-center mb-3"><span class="fw-bold me-2">Start Date:</span><span class="badge bg-label-success">{{ $sDate }}</span></li><li class="d-flex align-items-center mb-3"><span class="fw-bold me-2">End Date:</span><span class="badge bg-label-success">{{ $eDate }}</span></li></ul><small class="text-uppercase">Contact</small><ul class="list-unstyled mt-3 mb-0"><li class="mb-2"><strong>Organizer:</strong> {{ $event->organizer?:'Not provided' }}</li><li><strong>Email:</strong> @if($event->email)<a href="mailto:{{ $event->email }}">{{ $event->email }}</a>@else<span class="text-muted">Not provided</span>@endif</li></ul></div></div>
